...
public class MultiPlayerGame extends JFrame {
    ...
    ImageIcon image13 = new ImageIcon("Mineswipper/Media/smile.jpg");
    Game game;
...
//        timericone.setFont(new Font("Digital-7" ,FONT.BOLD,16));
